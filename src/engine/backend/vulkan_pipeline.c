                                  ...
                                  VulkanGraphicsPipeline pipeline[static 1])
{
    ...
    // layout
    {
        const VkDescriptorSetLayout layouts[]               = {create_info->vertex_shader_layout, create_info->fragment_shader_layout};
        const VkPipelineLayoutCreateInfo layout_create_info = {.sType                  = VK_STRUCTURE_TYPE_PIPELINE_LAYOUT_CREATE_INFO,
                                                               .pNext                  = NULL,
                                                               .flags                  = 0,
        ...
        VK_ERROR_HANDLE(vkCreatePipelineLayout(device->handle, &layout_create_info, NULL, &pipeline->layout), { return true; });
    }
    ...
    // pipeline
    {
        ...
        const VkPipelineInputAssemblyStateCreateInfo input_assembly_info = {.sType    = VK_STRUCTURE_TYPE_PIPELINE_INPUT_ASSEMBLY_STATE_CREATE_INFO,
        ...
        const VkRect2D scissor    = {.offset.x = 0.0f, .offset.y = 0.0f, .extent = {.width = create_info->width, .height = create_info->height}};
        const VkPipelineViewportStateCreateInfo viewport_info = {.sType         = VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_STATE_CREATE_INFO,
                                                                 .pNext         = NULL,
                                                                 .flags         = 0,
                                                                 .viewportCount = 1,
                                                                 .pViewports    = &viewport,
        ...
        const VkPipelineRasterizationStateCreateInfo rasterization_info = {.sType            = VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_CREATE_INFO,
                                                                           .pNext            = NULL,
                                                                           .flags            = 0,
        ...
        const VkPipelineMultisampleStateCreateInfo multisampling_info = {.sType                 = VK_STRUCTURE_TYPE_PIPELINE_MULTISAMPLE_STATE_CREATE_INFO,
                                                                         .pNext                 = NULL,
                                                                         .flags                 = 0,
        ...
        const VkPipelineDepthStencilStateCreateInfo depth_stencil_info = {.sType                 = VK_STRUCTURE_TYPE_PIPELINE_DEPTH_STENCIL_STATE_CREATE_INFO,
        ...
        const VkPipelineColorBlendStateCreateInfo color_blend_info = {.sType           = VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_STATE_CREATE_INFO,
        ...
        const VkGraphicsPipelineCreateInfo pipeline_create_info = {.sType               = VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_CREATE_INFO,
                                                                   .pNext               = NULL,
                                                                   .flags               = 0,
