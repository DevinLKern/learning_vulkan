...
static inline bool SelectVkSurfaceFormat(
    const VkSurfaceKHR                      surface, 
    const VkPhysicalDevice                  physical_device, 
    VkSurfaceFormatKHR                      surface_format          [static 1]
) {
    ...
    else { // TODO: select ideal surface format?
...
static inline bool SelectDepthFormat(
    const VkPhysicalDevice                  physical_device,
...
static inline bool CreateVkRenderPass(
